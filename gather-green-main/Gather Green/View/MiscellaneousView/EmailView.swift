            ...
            Group {
                ...
                HStack{
                    ...
                    TextField("Name", text: $name)
                        ...
                        .background(Color("accentColor2").opacity(0.3))
                        .cornerRadius(10)
                        .overlay(
...
//                        .lineLimit(5...10)
            ...
            Button(action: {
                let result:Bool = EmailHelper.shared.sendEmail(subject: subject, body: "I am \(name)" + Emailbody)
                if !result {
                    isAlert = true
                }
             }) {
...
//             Spacer()
        ...
        .onAppear(perform: {
            self.name = self.dataModel.user.fullName
        })
    }
}
